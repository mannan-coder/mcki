              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-2">
                  <div className="text-right">
                    ...
                    <button className="inline-flex items-center space-x-1 text-xs text-blue-500 hover:text-blue-400 bg-blue-50 hover:bg-blue-100 px-2 py-1 rounded transition-colors">
                      <span>Execute</span>
